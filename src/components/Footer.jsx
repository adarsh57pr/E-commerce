...
<footer className="bg-black">
  <div className="py-3 py-md-5 py-xl-8 py-xxl-4">
        ...
        <div className="col-12 col-md-6">
          <div className="link-wrapper">
            <ul className="m-0 list-unstyled">
              <li>
                <a href="#!" className="link-opacity-75-hover text-decoration-none link-light fs-1 lh-sm">
                  Shop
                </a>
              </li>
              <li>
            ...
            <div className="row">
              <div className="col-6">
                <div className="address-wrapper">
                  ...
                  <p className="m-0">
                    <a className="fs-7 link-light link-opacity-75 link-opacity-100-hover text-decoration-none" href="tel:+1-479-589-0693">
                      1-479-589-0693
                    </a>
                  </p>
                </div>
              ...
              <div className="col-6">
                <div className="address-wrapper">
                  ...
                  <p className="m-0">
                    <a className="fs-7 link-light link-opacity-75 link-opacity-100-hover text-decoration-none" href="tel:+540-284-4036">
                      540-284-4036
                    </a>
                  </p>
                </div>
              ...
              <div className="col-6">
                <div className="social-media-wrapper">
                  ...
                  <ul className="m-0 list-unstyled d-flex justify-content-start gap-3">
                    <li>
                      <a href="#!" className="link-opacity-75 link-opacity-100-hover link-light">
      ...
      <div className="row gy-3 align-items-lg-center">
        <div className="col-12 col-lg-6 order-1 order-lg-0">
          ...
          <div className="credit-wrapper d-block fs-9 text-light opacity-75 text-center text-lg-start">
            Built by<a href="https://bootstrapbrain.com/" className="link-light text-decoration-none">
        ...
        <div className="col-12 col-lg-6">
          <div className="link-wrapper">
            <ul className="m-0 list-unstyled d-flex justify-content-center justify-content-lg-end gap-2 gap-md-3">
              <li>
                <a href="#!" className="link-opacity-75 link-underline-opacity-0 link-opacity-100-hover link-underline-opacity-100-hover link-offset-1 link-light fs-8 d-flex align-items-center pe-2 pe-md-3 bsb-sep bsb-sep-border">
                  Shipping
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#!" className="link-opacity-75 link-underline-opacity-0 link-opacity-100-hover link-underline-opacity-100-hover link-offset-1 link-light fs-8 d-flex align-items-center">
                  Security
                </a>
              </li>
            </ul>
