  ...
  <div className="container">
    <div className="row justify-content-md-center">
      <div className="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
        <h2 className="mb-4 display-5 text-center text-black">Need Help</h2>
        <p className="text-dark mb-5 text-center lead fs-4">Our team is available to provide prompt and helpful responses to all inquiries. You can reach us via phone, email, or by filling out the contact form below.</p>
        <hr className="w-50 mx-auto mb-5 mb-xl-9 border-black" />
      </div>
    </div>
  </div>
  <div className="container">
        ...
        <div className="card border border-dark rounded shadow-sm overflow-hidden">
          <div className="card-body p-0">
            <div className="row gy-3 gy-md-4 gy-lg-0">
              <div className="col-12 col-lg-6 bsb-overlay background-position-center background-size-cover" style={{bsbOverlayOpacity: '0.7', backgroundImage: 'url("https://png.pngtree.com/thumb_back/fh260/background/20230609/pngtree-vintage-telephone-sitting-on-a-dark-table-with-old-telephone-cord-image_2942474.jpg")'}}>
