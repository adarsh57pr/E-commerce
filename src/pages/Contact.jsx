              ...
              <div className="card border border-dark rounded shadow-sm overflow-hidden">
                <div className="card-body p-0">
                  <div className="row gy-3 gy-md-4 gy-lg-0">
                    <div className="col-12 col-lg-6 bsb-overlay background-position-center background-size-cover" style={{ bsbOverlayOpacity: '0.7', backgroundImage: 'url("https://st2.depositphotos.com/1051355/6465/i/950/depositphotos_64652411-stock-photo-old-fashioned-telephone.jpg")' }}>
